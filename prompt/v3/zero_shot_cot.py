# 把注意事項跟資料提供順序交換，讓注意事項直接接在「任務」後
# 多說嚴格只聚焦 **提供之段落文字本身**
# reasoning 多說推論時必須提供段落中的原文
# 把 {risk_name} 加入 disclosure_type 的敘述中
...
每個 dict 包含以下欄位：
1. reasoning: str，**請一步步思考**，推論時**必須提供段落中的原文**，說明為何模型認為 **sentence** 有揭露或未揭露該風險；有揭露的話如何判斷 disclosure_type。 
